// constants/elSalvadorData.js
export const EL_SALVADOR_DATA = {
  "Ahuachapán": [
  ...
  "La Libertad": [
    ...
    "Jayaque", "Jicalapa", "La Libertad", "Nueva San Salvador", "Opico", "Quezaltepeque", 
  ...
  "La Unión": [
    ...
    "Intipucá", "La Unión", "Lilí", "Meanguera del Golfo", "Nueva Esparta", "Pasaquina", 
  ...
  "Usulután": [
    ...
    "San Francisco Javier", "Santa Elena", "Santa María", "Santiago de María", "Tecapán", 
    "Usulután"
  ]
};